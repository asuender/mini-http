...
A minimal HTTP/1.1 server, written in C. Please don't regard this as a production-grade implementation of such a service; it rather acts as mere toy project to enlarge my understanding of HTTP as well as improve my C programming capabilities.
